...
<body>
    <header>
        ...
        <div class="hero-text-box">
            <h1>Goobdye junk food. <br> super healthy meals.</h1>
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2">
                <img src="resources/img/app-iPhone.png" alt="Onmifood app on iPhone" class=" js--wp-2">
            </div>
            <div class="col span-1-of-2">
            ...
            <a href="#" class="btn-app"><img src="resources/img/download-app-iphone.png" alt="App Store Button"></a>
            <a href="#" class="btn-app"><img src="resources/img/download-app-android.png" alt="PLayStore Button"></a>
        </div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>1 meal 10 days/month
                            </li>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>Order 24/7
                            </li>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>Access to newest creations
                            </li>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>Free delivery
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>1 meal
                            </li>
                            <li>
                                <ion-icon name="checkmark" class="icon-small"></ion-icon>Order 8 am to 12 pm
                            </li>
                            <li>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    ...
                    <li><a href="#">
                            <ion-icon name="logo-twitter" class="ion-social-twitter"></ion-icon>
                        </a></li>
                    <li><a href="#">
                            <ion-icon name="logo-googleplus" class="ion-social-googleplus"></ion-icon>
                        </a></li>
                    <li><a href="#">
